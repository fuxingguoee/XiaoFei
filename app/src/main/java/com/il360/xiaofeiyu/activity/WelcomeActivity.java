...
public class WelcomeActivity extends AppCompatActivity {
	...
	private static COSClient oldCos;//新增
 ...
 // For Android 6.0
						...
						if (obj.getInt("code") == 1) {
							...
							if (arrayOfCardConfig.getList() != null && arrayOfCardConfig.getList().size() > 0) {
								...
								for (int i = 0; i < list.size(); i++) {
									...
									} else if (list.get(i).getConfigGroup().equals("txy") && list.get(i).getConfigName().equals("oldAppId")) {
										GlobalPara.cosOldAppID = list.get(i).getConfigValue();
	...
	public static COSClient getOldCOSClient(){//新增
		return oldCos;
	}
	...
	public void initOldCOSClient(){//新增
		String appid = GlobalPara.getCosOldAppID();
		String peristenceId = null;
		...
		oldCos = new COSClient(MyApplication.getContextObject(), appid, config, peristenceId);
	}
